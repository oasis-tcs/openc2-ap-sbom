...
This file: should be template-README-v0.4.txt (or similar)
...
pandoc -f gfm -t html <filename>.md -c styles/markdown-styles-v1.7.3.css --toc --toc-depth=5 -s -o <filename>.html --metadata title="Title of Specification Version 1.0"
